function [ F ] = haralick_features( glcm )
...
%   winzeck@hm.edu
%   
%  Updated 05/06/13 by Nick McCarthy (nicholas.mccarthy@gmail.com)
%  to include cluster shade and prominence features [3].
%
...
%   [3] F. Albregtsen: Statistical Texture Measures Computed from Gray Level Coocurrence Matrices
%     
% MISSING:   f14  [1]
%
% Input: 2-dimensional GLCM
% Output: Vector of 13 haralick features extracted
...
for i=1:S
    for j=1:S
        ...
        f_cprom(i,j) = ((cdelta^3) * glcm(i, j)); 
        
        f_cshad(i,j) = ((cdelta^4) * glcm(i, j));
    end
end
...
F = [f1 f2 f3 f4 f5 f6 f7 f8 f9 f10 f11 f12 f13 cshad cprom];
