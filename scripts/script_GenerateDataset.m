...
feature_dirs = {'datasets/PP2', 'datasets/SHAPE.features'} %, 'datasets/CICM-r1.features'} %, 'datasets/SHAPE.features'};

label_path = 'datasets/class.info/labels.csv';
filename_path = 'datasets/class.info/labels.csv';
